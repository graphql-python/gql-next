...
class DataclassesRenderer:
    ...
    def render(self, parsed_query: ParsedQuery):
        ...
        buffer.write('# AUTOGENERATED EOF')
        return str(buffer)
    ...
    def __render_header(self, buffer: CodeChunk):
        buffer.write('from functools import partial')
        buffer.write('from typing import Optional, Any, Callable, Mapping, List')
        ...
        if self.internal_ns:
            buffer.write('from types import SimpleNamespace')
        buffer.write('')
