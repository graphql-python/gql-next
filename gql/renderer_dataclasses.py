...
class DataclassesRenderer:
    ...
    def __do_render(self, buffer: CodeGenerator, node: MappingNode):
    ...
    def __render_field(self, buffer: CodeGenerator, node: MappingNode):
    ...
    def __render_operation(self, buffer: CodeGenerator, node: MappingNode):
    ...
    def __render_python_class(self, buffer: CodeGenerator, node: MappingNode):
