...
from gql.query_parser import ParsedQuery, ParsedField, ParsedObject, ParsedOperation, ParsedVariableDefinition
...
class DataclassesRenderer:
    ...
    def render(self, parsed_query: ParsedQuery):
        ...
        # Iteretae in reverse so that operation is last
